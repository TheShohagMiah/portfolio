...
const Dashboard = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        const [v, td, p, s] = await Promise.all([
          axios.get("http://localhost:5000/api/visitors/total"),
          axios.get("http://localhost:5000/api/visitors/today"),
          axios.get("http://localhost:5000/api/miscellaneous/total-projects"),
          axios.get("http://localhost:5000/api/miscellaneous/total-services"),
        ]);
        setDashData({
    ...
    // Track visitor
    axios
      .post("http://localhost:5000/api/visitors/track", { page: "/dashboard" })
      .catch(() => {});
  }, []);
