                ...
                <tbody className="divide-y divide-border/50">
                  <AnimatePresence mode="popLayout">
                    {filteredProjects.map((project, i) => (
                      <motion.tr
                        key={project._id} // ✅ FIX: was project.id (undefined)
                      ...
                      >
                        ...
                        <td className="px-6 py-6">
                          {(() => {
                            ...
                            return (
                              <div
                                className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest border ${currentStyle}`}
                              >
                                <div
